        ...
        <div className="bg-dark min-vh-100">
            <div className="row g-0">
                <div className="col-lg-7 d-none d-lg-block">
                    <Carousel>
                        <Carousel.Item className="imgs-1 min-vh-100">
                            <div className="carousel-caption d-none d-md-block"></div>
                        </Carousel.Item>
                        <Carousel.Item className="imgs-2 min-vh-100">
                            <div className="carousel-caption d-none d-md-block"></div>
                        </Carousel.Item>
                        <Carousel.Item className="imgs-3 min-vh-100">
                            <div className="carousel-caption d-none d-md-block"></div>
                        </Carousel.Item>
                        <Carousel.Item className="imgs-4 min-vh-100">
                            <div className="carousel-caption d-none d-md-block"></div>
                        </Carousel.Item>
                    </Carousel>
                </div>
